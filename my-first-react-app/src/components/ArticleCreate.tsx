    ...
    return <div className='createArticle'>
        ...
        <form className="createArticle__form needs-validation" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="createArticle__field createArticle__field-file">
                <label className="createArticle__field-title form-label">Image</label>
                ...
                <div className="createArticle__field-file_btn">Select the file</div>
            ...
            <div className="createArticle__field">
                <label className="createArticle__field-title form-label"><p>Title <span className='createArticle__field-required'>*</span></p>
            ...
            <div className="createArticle__field">
                <label className="createArticle__field-title form-label"><p>News url <span className='createArticle__field-required'>*</span></p>
            ...
            <div className="createArticle__field">
                <label className="createArticle__field-title form-label"><p>News topic <span className='createArticle__field-required'>*</span></p>
            ...
            <div className="createArticle__field">
                <label className="createArticle__field-title form-label"><p>Summary <span className='createArticle__field-required'>*</span></p>
            ...
            <button type="submit" className="createArticle__btn">Create article</button>
        </form>
